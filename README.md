...
I’ve been trying to add a new component Fe, and a new mineral, also a new reaction Ferrohydrite Fe(OH)2 = Fe + 2OH to the original system written in Hommel2019a. But I couldn’t get it to run.]space
...
added iron2.hh, ferrohydrite.hh]space
...
./dune-common/bin/dunecontrol --opts=./dumux/cmake.opts all]space



cd ./build-cmake/appl/icp/eicp

make columnleobox]space



./columnleobox leo_column1.input]space
